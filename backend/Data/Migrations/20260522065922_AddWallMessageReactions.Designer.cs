...
namespace backend.Data.Migrations
{
    ...
    [Migration("20260522065922_AddWallMessageReactions")]
    partial class AddWallMessageReactions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Entities.Comment", b =>
                {
                    ...
                    b.Property<string>("GuestWebsite")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
            ...
            modelBuilder.Entity("backend.Entities.HeroSlide", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
            ...
            modelBuilder.Entity("backend.Entities.PageView", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
            ...
            modelBuilder.Entity("backend.Entities.WallMessage", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(36)
                        .HasColumnType("character varying(36)");
                    ...
                    b.ToTable("WallMessages", (string)null);
                });
            ...
            modelBuilder.Entity("backend.Entities.WallMessageReaction", b =>
                {
                    ...
                    b.Property<string>("WallMessageId")
                        .IsRequired()
                        .HasMaxLength(36)
                        .HasColumnType("character varying(36)");
                    ...
                    b.HasIndex("WallMessageId", "DeviceId")
                        .IsUnique();

                    b.ToTable("WallMessageReactions", (string)null);
                });

            modelBuilder.Entity("backend.Entities.WorkExperience", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(36)
                        .HasColumnType("character varying(36)");
            ...
            modelBuilder.Entity("backend.Entities.WallMessageReaction", b =>
                {
                    b.HasOne("backend.Entities.WallMessage", "WallMessage")
                        .WithMany()
                        .HasForeignKey("WallMessageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("WallMessage");
                });
